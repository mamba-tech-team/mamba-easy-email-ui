...
import { IProductRecommendation } from '@demo/components/CustomBlocks/ProductRecommendation';
...
export const ProductCard = createCustomBlock<IProductCard>({
  name: 'Product card',
  type: CustomBlocksType.PRODUCT_CARD,
